...
my $data = $xml->XMLin($ENV{'GALACTICUS_DATA_PATH'}."/static/observations/galaxyColors/Galaxy_Colors_SDSS_Weinmann_2006.xml");
...
system("pdfmerge tmp.pdf tmp2.pdf ".$outputFile." > /dev/null 2>&1");
